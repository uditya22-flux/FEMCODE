document.addEventListener("DOMContentLoaded", () => {
  ...
  const products = {
    food: [
      ...
      { name: "Makana", price: "₹80", img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSTPaY1l0drT3a1kdg3YEJUPpjhc4E5AH3NHQ&s" },
    ...
    clothing: [
      { name: "Men T-Shirt", price: "₹499", img: "https://images.unsplash.com/photo-1586363104862-4b3e16a8fba1?auto=format&fit=crop&w=400&q=80" },
      { name: "Women Kurti", price: "₹899", img: "https://images.unsplash.com/photo-1618354691229-6f3a2e1f3f7d?auto=format&fit=crop&w=400&q=80" }
    ],
    electronics: [
      { name: "Smartphone", price: "₹14,999", img: "https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?auto=format&fit=crop&w=400&q=80" }
    ]
  };
